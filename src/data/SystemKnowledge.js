...
8. MOON MATRIX: ECONOMÍA REAL (FASE 1)
El sistema económico fluctúa en sincronía estricta con el calendario lunar real de las fases de la luna.
* Fases Lunares de la Moneda:
  🌑 NOVA (Luna Nueva): Precios bajos. Momento de comprar.
  🌓 CRESCENS (Cuarto Creciente): El valor de la moneda sube.
  🌕 PLENA (Luna Llena): Valor máximo. Moneda fuerte, ideal para gastar.
  🌗 DECRESCENS (Cuarto Menguante): El valor decrece. Convertir a FIAT.
* Sistema Forex (Las 2 Ruedas de RGartner):
  - RUEDA IN (Entrada): Adquisición de monedas, ganancias por ver BroStories, recibir Halos o jugar.
  - RUEDA OUT (Salida): Gasto de monedas obteniendo descuentos en comercios o canjeando por FIAT (Stripe). Los valores oscilarán (ej: 0,90€ a 1,10€).
