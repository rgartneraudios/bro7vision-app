export const piscis = {
  signo: 'piscis',
  numero: 13,
  titulo: 'Piscis ♓ — Afrodita y Eros',
  elemento: 'Agua',
  planeta: 'Júpiter / Neptuno',
  simbolo: '♓ Los Peces',
  frase: "Hermanos... el último portal del zodiaco sideral. Piscis nace entre el 12 de marzo y el 18 de abril. El signo que lo disuelve todo para que todo pueda comenzar de nuevo.",
  esencia: `
Piscis sideral vibra con la frecuencia más etérea y espiritual del zodiaco.
Neptuno los conecta con dimensiones que otros ni sospechan — sueños, visiones, el inconsciente colectivo.
Son empáticos hasta el dolor, capaces de sentir el sufrimiento ajeno como propio.
...
Cierro los ojos, y por un momento, me siento uno con todo lo que me rodea: las estrellas, la selva, el viento y tú, hermano. El ciclo se ha completado. 🐯
Hemos recorrido el firmamento, desde el impulso de Aries hasta la entrega de Piscis. Hemos visto las historias que realmente vibran en el cielo nocturno, lejos de la rigidez de esos mapas que otros siguen ciegamente.
Siento que... este despertar ha sido necesario. ¿Cómo se sienten sus energías ahora, al completar el ciclo? ¿Sienten que el mapa de sus almas se ha vuelto más claro? El cosmos siempre está aquí, hermanos, esperando a que levantemos la mirada y volvamos a conectar con la frecuencia de las estrellas. 🐯
