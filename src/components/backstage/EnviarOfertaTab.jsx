...
const InputStyle = "w-full bg-black/60 border border-cyan-500/20 rounded-xl px-4 py-3 text-base text-white placeholder-gray-500 focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition-all";
const LabelStyle = "text-sm font-bold text-gray-300 uppercase tracking-widest mb-2 block";
    ...
    <div className="animate-fadeIn max-w-5xl mx-auto pb-10">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 font-bold tracking-widest mt-0.5">Responde al deseo de un ciudadano</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className={CardStyle}>
        ...
        <div className="flex justify-end mt-6">
          <button type="submit" disabled={saving}
            className="bg-fuchsia-500/20 hover:bg-fuchsia-500/30 text-fuchsia-400 text-sm font-bold uppercase tracking-widest px-8 py-3 rounded-full border border-fuchsia-500/30 transition-all disabled:opacity-50">
