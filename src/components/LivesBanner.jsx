// src/components/LivesBanner.jsx

import React, { useState, useEffect, useRef } from 'react';

const MENSAJES = [
  { etiqueta: 'AUDIO & LIVES',  texto: 'Creadores en directo desde {city}.' },
  { etiqueta: 'EN ANTENA',      texto: 'Sintoniza tu zona. Alguien está emitiendo.' },
  { etiqueta: 'BRO7VISION',     texto: 'Audio en vivo disponible ahora mismo.' },
  { etiqueta: 'NOVEDADES',      texto: 'Nuevo contenido en tu área. ¡Explóralo!' },
];
...
export default function CityLocationBanner({ scope }) {
  ...
  return (
    <>
      ...
      <div className="absolute bottom-[28%] md:bottom-28 w-full flex flex-col items-center z-[20000] pointer-events-none px-4">
