    ...
    >
      <div
        ...
        style={{
          ...
          borderRadius: 16, padding: '2rem', maxWidth: 480, width: '90%',
          boxShadow: '0 0 40px rgba(0,255,255,0.15)',
        }}
      >
        <h2 style={{ color: '#00ffff', fontSize: 28, fontWeight: 900, textAlign: 'center', marginBottom: 8 }}>
          SHOP AMIGOS
        </h2>
        <p style={{ color: '#ccc', fontSize: 16, textAlign: 'center', marginBottom: 20 }}>
          {slot.nombre}
        </p>
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        height: '100%', paddingTop: 20, paddingLeft: 'clamp(40px, 8vw, 160px)',
      }}>
        <div style={{ display: 'flex', gap: 4, background: 'rgba(0,0,0,0.5)', borderRadius: 12, padding: 4, marginBottom: 16, marginTop: 80 }}>
          {['INTERNACIONAL', 'NACIONAL', 'CERCANIAS'].map(tab => {
        ...
        <div
          style={{
            flex: 1, width: '100%', maxWidth: '90vw',
        ...
        >
          {slots.length === 0 && (
            <div style={{ gridColumn: '1/-1', textAlign: 'center', color: 'rgba(255,255,255,0.3)', padding: 60 }}>
              No hay slots disponibles en esta categoría
            </div>
          )}
          {slots.map(slot => {
            const ocupado = slot.imagen_url;
            return (
              <div
                key={slot.id}
                onClick={() => ocupado && setSelectedSlot(slot)}
                style={{
              ...
              >
                {ocupado ? (
                  ...
                  <div style={{
                    ...
                    <span style={{ color: '#00FFFF', fontSize: 20, fontWeight: 700 }}>
                      ✦ Espacio disponible ✦
                    </span>
