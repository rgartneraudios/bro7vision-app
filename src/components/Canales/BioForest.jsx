...
const BioForest = ({ balances, setBalances, session, realityMode }) => {
...
const videoTipo   = proyeccion?.tipo || null;
  ...
  // NAVEGACIÓN TECLADO / D-PAD SMART TV
useEffect(()=>{
  const handleKey=(e)=>{
