...
const ChannelOeste169 = ({ balances, setBalances, session, realityMode, setShow169 }) => {
  ...
  const displayUsers = useMemo(() => {
    return TV_NODES.length===0?[{id:'loading_01',alias:'SINTONIZANDO...',video_file:''}]:TV_NODES;
  }, []);
