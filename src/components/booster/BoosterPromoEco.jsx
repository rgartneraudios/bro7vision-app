...
export default function BoosterPromoEco({ userId }) {
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="flex items-center gap-4 p-5 rounded-2xl bg-green-950/20 border border-green-500/20">
        <span className="text-3xl">📡</span>
        <div>
          <p className="text-green-300 font-black text-lg">{creditos} crédito{creditos !== 1 ? 's' : ''} disponible{creditos !== 1 ? 's' : ''}</p>
          <p className="text-gray-500 text-xs uppercase tracking-widest">Cada PromoECO publicada consume 1 crédito</p>
        </div>
      </div>
