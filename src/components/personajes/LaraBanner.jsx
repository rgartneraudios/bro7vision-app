// src/components/personajes/LaraBanner.jsx
...
export default function LaraBanner({
  ...
  const { mensaje, loading, enviar } = useAgentLara({
    iaMode,
    isAdmin,
    onHandoff,
    ciudad,
    ...
    <div className="absolute inset-0 z-[50] pointer-events-none">
      <style>{`
        ...
        .lara-texto {
          ...
          line-height: 1.5;
          min-height: 3em;
          animation: neonPulseLara 3s ease-in-out infinite;
        }
        .lara-cursor {
        ...
        .lara-loading {
          animation: neonPulseLara 1s ease-in-out infinite;
          color: ${slateColor};
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-end pb-0 px-4" style={{ zIndex: 3 }}>
        <div className="w-full max-w-2xl mb-3 pointer-events-auto">
          <div className="lara-wrap w-full">
            ...
            <div className="flex flex-col items-center justify-center text-center">
              {loading ? (
                <p className="lara-loading">buscando...</p>
              ) : currentMsg ? (
                <p className="lara-texto">
                  {display}
                  <span className="lara-cursor" style={{ opacity: cursor ? 1 : 0 }} />
                </p>
              ) : null}
            </div>
          </div>
